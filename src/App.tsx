...
export default function App() {
  ...
  const services = [
    {
      ...
      description: "Instal ulang Windows, driver, aplikasi desain, office, dan optimasi performa laptop Anda.",
      color: "bg-indigo-50 text-indigo-600"
    },
    {
      icon: <Wrench className="w-8 h-8" />,
      title: "Service Hardware",
      description: "Perbaikan hardware laptop, ganti keyboard, layar pecah, engsel rusak, hingga servis mesin/motherboard.",
      color: "bg-yellow-50 text-yellow-600"
    },
    {
      icon: <Package className="w-8 h-8" />,
      title: "Jual Beli Laptop",
      description: "Terima tukar tambah, jual laptop baru dan bekas berkualitas dengan garansi terpercaya.",
  ...
  const features = [
    {
      ...
      description: "Setiap layanan servis dan unit yang kami jual dilengkapi dengan garansi resmi toko."
    },
    {
      icon: <Zap className="w-6 h-6" />,
      title: "Proses Cepat",
      description: "Kami mengutamakan kecepatan tanpa mengurangi kualitas pengerjaan."
    },
    {
      icon: <Cpu className="w-6 h-6" />,
      title: "Teknisi Ahli",
      description: "Ditangani oleh teknisi berpengalaman yang memahami berbagai brand laptop."
    }
  ];

  const laptops = [
    { name: "MacBook Air M1", price: "Rp 10.xxx.xxx", image: "https://images.unsplash.com/photo-1611186871348-b1ce696e52c9?auto=format&fit=crop&q=80&w=800" },
    { name: "Asus ROG Strix", price: "Rp 12.xxx.xxx", image: "https://images.unsplash.com/photo-1593642632823-8f785ba67e45?auto=format&fit=crop&q=80&w=800" },
    { name: "Lenovo ThinkPad", price: "Rp 5.xxx.xxx", image: "https://images.unsplash.com/photo-1541807084-5c52b6b3adef?auto=format&fit=crop&q=80&w=800" },
    { name: "Dell XPS 13", price: "Rp 15.xxx.xxx", image: "https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?auto=format&fit=crop&q=80&w=800" },
  ];
  ...
  return (
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 overflow-x-hidden">
      ...
      <main>
        {/* Hero Section */}
        <section id="hero" className="relative md:min-h-screen flex items-center bg-white overflow-hidden pt-32 md:pt-48">
          <div className="max-w-7xl mx-auto px-10 grid grid-cols-12 gap-0 w-full items-center pt-8 pb-20 md:py-0">
            <motion.div 
          ...
          <div className="max-w-7xl mx-auto px-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {services.map((service, idx) => (
                ...
                >
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-8 text-3xl group-hover:scale-110 transition-transform ${service.color.split(' ')[0]} ${service.color.split(' ')[1]}`}>
                    {service.icon}
                  </div>
              ...
              {laptops.map((laptop, idx) => (
                <div key={idx} className="group cursor-pointer">
                  <div className="relative aspect-[4/5] rounded-[32px] overflow-hidden mb-6 shadow-md group-hover:shadow-indigo-100 group-hover:shadow-2xl transition-all">
                    ...
                    <div className="absolute top-6 left-6 bg-white/90 backdrop-blur px-3 py-1.5 rounded-xl text-xs font-black uppercase tracking-widest border border-white">
                      Available
                    </div>
                  </div>
                  <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-6 justify-center md:justify-start">
                  <a href="https://wa.me/6281234567890" className="px-10 py-5 bg-yellow-400 text-slate-900 font-extrabold rounded-3xl text-xl shadow-2xl hover:bg-yellow-300 transition-all flex items-center gap-3">
                    <Phone className="w-6 h-6" /> Chat WhatsApp
                  </a>
                  <div className="flex flex-col justify-center">
                    <span className="font-black text-2xl leading-none">0812-3456-7890</span>
                ...
                <div className="space-y-6">
                  <div className="flex gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 font-medium">Jl. Pemuda No. 45, Jakarta Timur</p>
                    </div>
                  </div>
                  <div className="flex gap-4">
                    <div className="w-12 h-12 bg-indigo-50 rounded-2xl flex items-center justify-center text-indigo-600 border border-indigo-100 shrink-0">
                    ...
                    <div>
                      ...
                      <p className="text-slate-500 font-medium">Setiap Hari: 09:00 - 20:00 WIB</p>
                    </div>
                  </div>
                </div>
                <div className="mt-10 rounded-3xl overflow-hidden h-48 bg-slate-100 grayscale hover:grayscale-0 transition-all cursor-pointer border border-slate-200">
      ...
      {/* Footer */}
      <footer className="bg-slate-900 py-10 px-10 border-t border-white/5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 text-xs text-slate-500 font-bold uppercase tracking-widest">
          <div className="flex items-center gap-4">
             ...
             <span>Jl. Pemuda No. 45, Jakarta</span>
          </div>
